...
class PendidikanController extends Controller
{
    ...
    */
    ...
    public function pembimbing_store(Request $request) {
        ...
        return redirect('/dosen/pendidikan/pembimbing')->with('pesan', "Arsip dengan nomor dokumen {$request['nomor_dokumen']} berhasil disimpan");
    }
    ...
    public function pembimbing_update(Request $request, $id) {
        ...
        return redirect('/dosen/pendidikan/pembimbing')->with('pesan', "Arsip dengan nomor dokumen {$request['nomor_dokumen']} berhasil diupdate");
    }
        ...
        return datatables()
            ...
            ->addColumn('aksi', function($row){
                ...
                <div class="d-flex justify-content-around">
                    <a href="/dosen/pendidikan/pembimbing/edit/'. $row->id .'" class="btn btn-icon btn-sm btn-outline-warning"><span class="tf-icons bx bx-edit-alt"></span></a>
    ...
    */
    ...
    public function jadwal_kuliah_store(Request $request) {
        ...
        return redirect('/dosen/pendidikan/jadwal_kuliah')->with('pesan', "Arsip dengan nomor dokumen {$request['nomor_dokumen']} berhasil disimpan");
    }
    ...
    public function jadwal_kuliah_update(Request $request, $id) {
        ...
        return redirect('/dosen/pendidikan/jadwal_kuliah')->with('pesan', "Arsip dengan nomor dokumen {$request['nomor_dokumen']} berhasil diupdate");
    }
    ...
    protected function dataTable_jadwal_kuliah(){
        ...
        return datatables()
            ...
            ->addColumn('aksi', function($row){
                return '
                <div class="d-flex justify-content-around">
                    <a href="/dosen/pendidikan/jadwal_kuliah/edit/'. $row->id .'" class="btn btn-icon btn-sm btn-outline-warning"><span class="tf-icons bx bx-edit-alt"></span></a>
                    <button class="btn btn-icon btn-sm btn-outline-danger" onclick="confirmDelete('.$row->id.')" ><span class="tf-icons bx bx-trash"></span></button>
                </div>';
            })
            ->addColumn('tanggal_dokumen', function($row){
    ...
    */
    ...
    public function yudisium_store(Request $request) {
        ...
        return redirect('/dosen/pendidikan/yudisium')->with('pesan', "Arsip dengan nomor dokumen {$request['nomor_dokumen']} berhasil disimpan");
    }
    ...
    public function yudisium_update(Request $request, $id) {
        ...
        return redirect('/dosen/pendidikan/yudisium')->with('pesan', "Arsip dengan nomor dokumen {$request['nomor_dokumen']} berhasil diupdate");
    }
    ...
    protected function dataTable_yudisium(){
        ...
        return datatables()
            ...
            ->addColumn('aksi', function($row){
                return '
                <div class="d-flex justify-content-around">
                    <a href="/dosen/pendidikan/yudisium/edit/'. $row->id .'" class="btn btn-icon btn-sm btn-outline-warning"><span class="tf-icons bx bx-edit-alt"></span></a>
                    <button class="btn btn-icon btn-sm btn-outline-danger" onclick="confirmDelete('.$row->id.')" ><span class="tf-icons bx bx-trash"></span></button>
                </div>';
            })
            ->addColumn('tanggal_dokumen', function($row){
    ...
    */
    ...
    public function koorprodi_store(Request $request) {
        ...
        return redirect('/dosen/pendidikan/koorprodi')->with('pesan', "Arsip dengan nomor dokumen {$request['nomor_dokumen']} berhasil disimpan");
    }
    ...
    public function koorprodi_update(Request $request, $id) {
        ...
        return redirect('/dosen/pendidikan/koorprodi')->with('pesan', "Arsip dengan nomor dokumen {$request['nomor_dokumen']} berhasil diupdate");
    }
    ...
    protected function dataTable_koorprodi(){
        ...
        return datatables()
            ...
            ->addColumn('aksi', function($row){
                return '
                <div class="d-flex justify-content-around">
                    <a href="/dosen/pendidikan/koorprodi/edit/'. $row->id .'" class="btn btn-icon btn-sm btn-warning"><span class="tf-icons bx bx-edit-alt"></span></a>
    ...
    */
    ...
    public function lainnya_store(Request $request) {
        ...
        return redirect('/dosen/pendidikan/lainnya')->with('pesan', "Arsip dengan nomor dokumen {$request['nomor_dokumen']} berhasil disimpan");
    }
    ...
    public function lainnya_update(Request $request, $id) {
        ...
        return redirect('/dosen/pendidikan/lainnya')->with('pesan', "Arsip dengan nomor dokumen {$request['nomor_dokumen']} berhasil diupdate");
    }
    ...
    protected function dataTable_lainnya(){
        ...
        return datatables()
            ...
            ->addColumn('aksi', function($row){
                return '
                <div class="d-flex justify-content-around">
                    <a href="/dosen/pendidikan/lainnya/edit/'. $row->id .'" class="btn btn-icon btn-sm btn-outline-warning"><span class="tf-icons bx bx-edit-alt"></span></a>
                    <button class="btn btn-icon btn-sm btn-outline-danger" onclick="confirmDelete('.$row->id.')" ><span class="tf-icons bx bx-trash"></span></button>
                </div>';
            })
            ->addColumn('tanggal_dokumen', function($row){
