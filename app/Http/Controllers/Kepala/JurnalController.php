...
class JurnalController extends Controller
{
      ...
      return datatables()
            ...
            ->addColumn('aksi', function($row){
              ...
              <div class="d-flex justify-content-around">
                  <a href="/kepala/jurnal/edit/'. $row->id .'" class="btn btn-icon btn-sm btn-outline-warning"><span class="tf-icons bx bx-edit-alt"></span></a>
                  ...
                  <a href="/kepala/jurnal/history/'. $row->id .'" class="btn btn-icon btn-sm btn-outline-primary" title="Tambah History"><span class="tf-icons bx bx-history"></span></a>
              </div>';
            })
  ...
  public function jurnal_store(Request $request){
    ...
    return redirect('kepala/jurnal')->with('pesan','Jurnal Berhasil ditambahkan');
  ...
  public function jurnal_update(Request $request, $id){
    ...
    return redirect('kepala/jurnal')->with('pesan','Jurnal Berhasil diupdate!');
  }
  ...
  public function jurnal_history_store(Request $request){
    ...
    return redirect("kepala/jurnal/history/$request->id")->with('pesan','History berhasil ditambahakan!');
  }
