...
@endpush
@section('title',Breadcrumbs::render('yudisium'))
...
<div class="col-lg-12 mt-3">
  <div class="card mb-4">
    <div class="card-body">
      <h5 class="card-title">Tabel data SK YUDISUM</h5>
      {{-- <div class="card-subtitle text-muted mb-3">Card subtitle</div> --}}
      <a href="{{ url('/dosen/pendidikan/yudisium/add') }}" class="btn btn-md btn-outline-primary mb-4">
        <span class="tf-icons bx bx-plus-medical"></span>&nbsp; SK YUDISUM
      </a>
...
<script type="text/javascript">
  $(function () {
    let table = $('#example').DataTable({
      ...
      ajax: "{{ route('dosen.dataTable.yudisium') }}",
      columns: [
        {data: '', name: ''},
        {data: 'aksi', name: 'aksi'},
...
function confirmDelete(data_id) {
    ...
    .then((willDelete) => {
        if (willDelete) {
        window.location.href = ("/dosen/pendidikan/yudisium/delete/"+data_id);
        } else {
