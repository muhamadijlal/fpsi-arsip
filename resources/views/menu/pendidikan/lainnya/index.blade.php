...
@endpush
@section('title',Breadcrumbs::render('lainnya'))
...
<div class="col-lg-12 mt-3">
  <div class="card mb-4">
    <div class="card-body">
      <h5 class="card-title">Tabel data SK LAINNYA</h5>
      {{-- <div class="card-subtitle text-muted mb-3">Card subtitle</div> --}}
      <a href="{{ url('/dosen/pendidikan/lainnya/add') }}" class="btn btn-md btn-outline-primary mb-4">
        <span class="tf-icons bx bx-plus-medical"></span>&nbsp; SK LAINNYA
      </a>
...
<script type="text/javascript">
  $(function () {
    let table = $('#example').DataTable({
      ...
      ajax: "{{ route('dosen.dataTable.lainnya') }}",
      columns: [
        {data: '', name: ''},
        {data: 'aksi', name: 'aksi'},
...
function confirmDelete(data_id) {
    ...
    .then((willDelete) => {
      if (willDelete) {
      window.location.href = ("/dosen/pendidikan/lainnya/delete/"+data_id);
      } else {
