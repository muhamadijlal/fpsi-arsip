...
@section('title',Breadcrumbs::render('koorprodi.create'))
...
<div class="card">
  <div class="card-body">
    <div class="row">
      <div class="col">
        <form action="{{ Auth::user()->role == 'dosen' ? url('/dosen/pendidikan/koorprodi/store') : url('/root/pendidikan/koorprodi/store') }}" method="post" enctype="multipart/form-data">
          @csrf

          <div class="mb-3">
            <label for="nomor_dokumen">Nomor SK Penetapan Koordinator dan Program Studi<span style="color:red;" class="form-label"> *</span></label>
