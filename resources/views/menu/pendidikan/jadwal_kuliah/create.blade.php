...
@section('title',Breadcrumbs::render('jadwal.create'))
...
<div class="card">
  <div class="card-body">
    <div class="row">
      <div class="col">
        <form action="{{ Auth::user()->role == 'dosen' ? url('/dosen/pendidikan/jadwal_kuliah/store') : url('/root/pendidikan/jadwal_kuliah/store') }}" method="post"
