...
@section('title',Breadcrumbs::render('pembimbing.create'))
...
<div class="card">
  <div class="card-body">
    <div class="row">
      <div class="col">
        <form action="{{url('/dosen/pendidikan/pembimbing/store')}}" method="post"
            enctype="multipart/form-data">
            @csrf

            <div class="mb-3">
                <label for="nomor_dokumen">Nomor SK pembing KP/TA/PKM<span style="color:red;" class="form-label"> *</span></label>
