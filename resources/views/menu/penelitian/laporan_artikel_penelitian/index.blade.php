...
@endpush
@section('title',Breadcrumbs::render('laporanArtikel'))
...
<div class="col-lg-12 mt-3">
  <div class="card mb-4">
    <div class="card-body">
      <h5 class="card-title">Tabel Data Laporan dan Artikel Penelitian</h5>
      {{-- <div class="card-subtitle text-muted mb-3">Card subtitle</div> --}}
      <a href="{{ url('/dosen/penelitian/laporan/artikel/add') }}" class="btn btn-md btn-outline-primary mb-4">
        <span class="tf-icons bx bx-plus-medical"></span>&nbsp; Laporan dan Artikel Penelitian
      </a>
...
<script type="text/javascript">
  $(function () {
    let table = $('#example').DataTable({
      ...
      ajax: "{{ route('dosen.dataTable.laporan_artikel_penelitian') }}",
      columns: [
        {data: '', name: ''},
        {data: 'aksi', name: 'aksi'},
...
function confirmDelete(data_id) {
    ...
    .then((willDelete) => {
        if (willDelete) {
        window.location.href = ("/dosen/penelitian/laporan/artikel/delete/"+data_id);
        } else {
