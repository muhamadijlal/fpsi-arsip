...
@section('title',Breadcrumbs::render('laporanArtikel.create'))
...
<div class="card">
  <div class="card-body">
    <div class="row">
      <div class="col">
        <form action="{{url('/dosen/penelitian/laporan/artikel/store')}}" method="post"
            enctype="multipart/form-data">
            @csrf

            <div class="mb-3">
                <label for="nomor_dokumen">Nomor Surat Penelitian<span style="color:red;" class="form-label"> *</span></label>
