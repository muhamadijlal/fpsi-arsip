        ...
        <div class="container">
            <div class="deskripsi">
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td>Perihal</td>
                        <td>:</td>
                        <td style="padding-left:5px;"><b>Permohonan Ijin Observasi</b></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="tabel-data">
                <table class="tabelData">
                    <h4 style="margin-left: 95px; margin-bottom: 0px;">Dosen Pengampu : {{ ucwords($observasi->pengamppu) }}</h4>
                    <thead>
                    ...
                    <tbody>
                        <tr class="tr">
                            <td class="td">1</td>
                            <td class="td">{{ ucwords($observasi->nama) }}</td>
            ...
            <div class="deskripsi">
                <p class="p1">
                    Untuk melaksanakan observasi tersebut, kami telah mewajibkan mahasiswa untuk senantiasa memperhatikan, menerapkannya dan melaksanakan protokol kesehatan serta mengikuti peraturan yang berlaku ditempat Bapak/Ibu.
                </p>
                <p class="p2">
