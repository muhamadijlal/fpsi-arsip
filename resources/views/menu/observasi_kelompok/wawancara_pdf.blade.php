...
<head>
    <meta charset="utf-8">
    <title>Surat Ijin Wawancara Kelompok</title>
...
<body class="F4">
    ...
    <article>
        ...
        <div class="container">
            <div class="deskripsi">
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td>Perihal</td>
                        <td>:</td>
                        <td style="padding-left:5px;"><b>Permohonan Ijin Wawancara</b></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="isi_surat">
                <p>
                    {{ ucwords($observasi->agenda) }} pada program studi Psikologi Universitas Buana Perjuangan karawang. Kami berharap Bapak/Ibu Pimpinan memberikan ijin wawancara dilembaga yang bapak/ibu pimpin kepada mahasiswa kami yang bernama:                    
                </p>
            </div>
            ...
            <div class="deskripsi">
                <p class="p1">
                    Untuk melaksanakan wawancara tersebut, kami telah mewajibkan mahasiswa untuk senantiasa memperhatikan, menerapkannya dan melaksanakan protokol kesehatan serta mengikuti peraturan yang berlaku ditempat Bapak/Ibu.
                </p>
                <p class="p2">
