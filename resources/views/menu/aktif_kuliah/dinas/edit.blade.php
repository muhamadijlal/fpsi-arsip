...
@section('title',Auth::user()->role != 'tu' ? Breadcrumbs::render('aktifKuliah.Mahasiswa.dinas.edit', $aktif) : Breadcrumbs::render('aktifKuliah.Tu.dinas.edit', $aktif))
...
<div class="card">
  <div class="card-body">
    <div class="row">
      <div class="col">
        <form action="{{ Auth::user()->role != 'mahasiswa' ? route('tu.dinas_aktif_kuliah_update', $aktif->id) : route('mahasiswa.dinas_aktif_kuliah_update', $aktif->id) }}" method="post">
          @method('PUT')
          @csrf
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" value="{{ $aktif->alamat }}" autocomplete="off">
            @error('alamat')
            <div class="text-danger">
                {{ $message }}
            </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('nama_orangtua') is-invalid @enderror" name="nama_orangtua" id="nama_orangtua" value="{{ $aktif->nama_orangtua }}" autocomplete="off">
            @error('nama_orangtua')
            <div class="text-danger">
                {{ $message }}
            </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('instansi_orangtua') is-invalid @enderror" name="instansi_orangtua" id="instansi_orangtua" value="{{ $aktif->instansi_orangtua }}" autocomplete="off">
            ...
            <div class="col-lg">
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('jabatan') is-invalid @enderror" name="jabatan" id="jabatan" value="{{ $aktif->jabatan }}" autocomplete="off">
                @error('jabatan')
                <div class="text-danger">
                    {{ $message }}
                </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nip_orangtua') is-invalid @enderror" name="nip_orangtua" id="nip_orangtua" value="{{ $aktif->nip_orangtua }}" autocomplete="off">
                @error('nip_orangtua')
                <div class="text-danger">
                    {{ $message }}
                </div>
            ...
            <div class="col-lg">
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('pangkat_golongan') is-invalid @enderror" name="pangkat_golongan" id="pangkat_golongan" value="{{ $aktif->pangkat_golongan }}" autocomplete="off">
          ...
          <div class="mb-3">
            ...
            <select class="form-control @error('keperluan') is-invalid @enderror" id="keperluan" name="keperluan">
              ...
              <option  {{ $aktif->keperluan == 'dinas' ? 'selected' : '' }} value="dinas">Dinas</option>
            </select>
            @error('keperluan')
              <div class="text-danger">
                {{ $message }}
