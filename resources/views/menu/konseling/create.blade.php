...
@section('title', Auth::user()->role != 'tu' ? Breadcrumbs::render('konseling.create') : Breadcrumbs::render('tu/konseling.create'))
...
<div class="card">
  <div class="card-body">
    <div class="row">
      <div class="col">
        <form action="{{ Auth::user()->role != 'dosen' ? route('tu.konseling_store') : route('dosen.konseling_store') }}" method="post">
          @csrf
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="mb-3">
                ...
                <input class="form-control @error('tanggal_awal') is-invalid @enderror" type="date" name="tanggal_awal" id="tanggal_awal" value="{{old('tanggal_awal')}}">
                @error('tanggal_awal')
                  <div class="text-danger">
                      {{ $message }}
                  </div>
            ...
            <div class="col-lg">
              <div class="mb-3">
                ...
                <input class="form-control @error('tanggal_akhir') is-invalid @enderror" type="date" name="tanggal_akhir" id="tanggal_akhir" value="{{old('tanggal_akhir')}}">
                @error('tanggal_akhir')
                  <div class="text-danger">
                      {{ $message }}
                  </div>
