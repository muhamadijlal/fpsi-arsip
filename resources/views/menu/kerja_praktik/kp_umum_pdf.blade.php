        ...
        <div class="container">
            ...
            <div class="isi_surat">
                <p>
                    ...
                    <br>Dengan ini, kami mohon kesediaan memberikan kesempatan kepada mahasiswa/i kami untuk melaksanakan kerja praktik di perusahaan/intansi Bapak/Ibu. Mahasiswa tersebut adalah:
                </p>
            </div>
            ...
            <div class="tabel-data">
                <table class="tabelData">
                    <thead>
                        <th width="40%" style="border: 1px solid; word-wrap: break-word;">Nama</th>
                    ...
                    <tbody>
                        <tr>
                            <td style="border: 1px solid;">{{ strtoupper($kp->nama) }}</td>
            ...
            <div class="ttd">
                <table>
                    ...
                    <tr>
                        <td>
                            <b>Dr. Cempaka Putrie Dimala, S.Psi.,M.Psi</b><br>
                            <b>NIK.416200008</b>
                        </td>
                    </tr>
                </table>
